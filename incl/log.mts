...
export default class log {
    ...
    public static debug = (...args: any[]): void => {
        if (logLevel <= LogLevel.DEBUG) c.debug(logMsg(timeStamp(), LogFormat.gray, 'DEBUG', formatArgs(...args)));
    };
    ...
    public static info = (...args: any[]): void => {
        if (logLevel <= LogLevel.INFO) c.info(logMsg(timeStamp(), LogFormat.cyan, 'INFO', formatArgs(...args)));
    };
    ...
    public static warn = (...args: any[]): void => {
        if (logLevel <= LogLevel.WARN) c.warn(logMsg(timeStamp(), LogFormat.yellow, 'WARN', formatArgs(...args)));
    };
    ...
    public static error = (...args: any[]): void => {
        if (logLevel <= LogLevel.ERROR) c.error(logMsg(timeStamp(), LogFormat.red, 'ERROR', formatArgs(...args)));
    };
    ...
    public static done = (...args: any[]): void => {
        if (logLevel <= LogLevel.DONE) c.log(logMsg(timeStamp(), LogFormat.green, 'DONE', formatArgs(...args)));
    };
    ...
    public static print = (...args: any[]): void => {
        if (logLevel <= LogLevel.PRINT) c.log(logMsg(timeStamp(), LogFormat.white, ' LOG ', formatArgs(...args)));
    };
};
